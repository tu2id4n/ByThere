...
--v2 add
function LookaheadBuilder:_construct_without_transition()
  ...
  self.lookahead.without_nn = WithoutNN()
  self.lookahead.without_nn:start_computation(self.lookahead.next_round_pot_sizes, self.lookahead.batch_size)
...
function LookaheadBuilder:construct_data_structures()
  ...
  -- print("Total depth: ", self.lookahead.depth)
  -- print(self.lookahead.bets_count)
  -- print(self.lookahead.nonterminal_nonallin_nodes_count)
  ...
  for d=3,self.lookahead.depth do
    ...
    if d < self.lookahead.depth then
      ...
      -- print("depth: ", d, ",shape should be ",self.lookahead.bets_count[d-1], "*", self.lookahead.nonallinbets_count[d-2], "*", self.lookahead.nonterminal_nonallin_nodes_count[d-2], "*", self.lookahead.batch_size, "*", constants.players_count, "*", game_settings.hand_count, ". we get inner_nodes size: \n", self.lookahead.inner_nodes[d]:size())
...
function LookaheadBuilder:build_from_tree(tree)
  ...
  --guo add this to show the structure after compute
  --print("bet_count ",  self.lookahead.bets_count)
  --print("nonallinbets ", self.lookahead.nonallinbets_count)
  --print("terminal ",  self.lookahead.terminal_actions_count)
  --print("actions count ", self.lookahead.actions_count)
  ...
  self:_construct_without_transition()
...
function LookaheadBuilder:_compute_tree_structures(current_layer, current_depth)
  ...
  --all inner and terminal
  if self.lookahead.bets_count[current_depth] == 0 and layer_inner_count ~= 0 then
    self.lookahead.bets_count[current_depth] = 1
  end
