...
-- guo change this, because cuda out of memory
params.gpu = true
params.half = false
-- guo add this
...
if params.gpu then
  require 'cutorch'
  if params.half then
    params.Tensor = torch.CudaHalfTensor
  else
